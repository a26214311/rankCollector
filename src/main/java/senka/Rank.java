...
public class Rank {
	...
	public static void main(String[] args) {
		...
		try {
			Rank.runRankTask("20bce434daeb3cd9461fd96f1d873de16051d396", 19, TimerTask.id19);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void getRank()throws Exception{
		...
		int page=1;
		String token = "b52888440ff00b091aacdf570f6f581464336656";
		int server = 8;
		int userid = 8156938;
...
//	private static long[] Il = new long[]{7796, 6074, 5621, 2139, 3065, 4132653, 1033183, 4791, 7545, 4617, 13, 6048, 3791, 10, 6913, 9038, 1000, 1875979};
	private static long[] Il = new long[]{7898, 5276, 3851, 2139, 5815, 4132653, 1033183, 4659, 7117, 7428, 13, 1653, 3791, 10, 3119, 7561, 1000, 1875979};
