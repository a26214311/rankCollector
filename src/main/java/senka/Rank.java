...
public class Rank {
	...
	public static void main(String[] args) {
		...
		try {
			Rank.runRankTask("bf12857b936cde3d8b3a0740dc04b2bd5e658eda", 15, TimerTask.id15);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//	private static long[] Il = new long[]{8188, 8093, 5187, 2139, 5638, 4132653, 1033183, 6469, 6090, 9676, 13, 8706, 3791, 10, 5097, 9023, 1000, 1875979};
	private static long[] Il = new long[]{6014, 2007, 5871, 2139, 6902, 4132653, 1033183, 6377, 4528, 2669, 13, 5416, 3791, 10, 6179, 7517, 1000, 1875979};
