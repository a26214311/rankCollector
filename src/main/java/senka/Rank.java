...
public class Rank {
	...
	public static void main(String[] args) {
		...
		try {
			Rank.runRankTask("8191b0e1a4ff04bd73a21be61991dbb70b679f2b", 20, TimerTask.id20);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//	private static long[] Il = new long[]{7796, 6074, 5621, 2139, 3065, 4132653, 1033183, 4791, 7545, 4617, 13, 6048, 3791, 10, 6913, 9038, 1000, 1875979};
	private static long[] Il = new long[]{9542, 2404, 5208, 2139, 6773, 4132653, 1033183, 3436, 8280, 2357, 13, 5795, 3791, 10, 7599, 8707, 1000, 1875979};
